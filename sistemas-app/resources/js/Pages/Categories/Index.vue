...
<template>
    <AppLayout>
        <template #header>
            <h1 class="font-semibold text-xl-gray-800 leading-tight" >Categories</h1>
        </template>
                            ...
                            <li class="flex justify-between gap-x-6 py-5" v-for="category in categories.data">
                                ...
                                <div class="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
                                    <p class="text-md leading-6 text-gray-900">
                                        ...
                                        <Link class="py-2 px-4 text-red-600" @click="deleteCategory(category.id)" v-if="$page.props.user.permissions.includes('delete categories')">Delete</Link></p>
                                </div>
                            </li>
                        </ul>
                    </div>
