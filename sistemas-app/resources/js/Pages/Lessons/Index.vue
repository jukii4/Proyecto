...
defineProps({
    lessons: {  // Corregido de 'categories' a 'lessons'
        type: Object,
        required: true
    }
})
...
<template>
    <AppLayout>
        <template #header>
            <h1 class="font-semibold text-xl-gray-800 leading-tight" >Lessons</h1>
        </template>
                            ...
                            <li class="flex justify-between gap-x-6 py-5" v-for="lesson in lessons.data">
                                ...
                                <div class="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
                                    <p class="text-md leading-6 text-gray-900">
                                        ...
                                        <Link class="py-2 px-4 text-red-600" @click="deleteLesson(lesson.id)" v-if="$page.props.user.permissions.includes('delete lessons')">Delete</Link></p>
                                </div>
                            </li>
                        </ul>
                    </div>
